...
export const metadata: Metadata = {
  title: 'Heart Disease Prediction | Ahsan Ullah',
  description: 'Case study: a Machine Learning classification project predicting heart disease risk.',
}

export default function HeartDiseasePredictionPage() {
  const project = knowledgeBase.projects.find((p) => p.slug === 'heart-disease-prediction')!
